export const authCopy = {
  ...
  bridge: {
    eyebrow: "Connection",
    title: "Connecting",
    body: "Keep this overlay open while the website connects your account to the extension from settings.",
    waitingLabel: "Connecting to extension",
    successLabel: "Connected",
    successBody: "The extension confirmed the connection. This window can close now.",
